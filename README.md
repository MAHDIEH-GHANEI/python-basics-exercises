...
- Greeting program (user welcome message)
...
📌 Purpose:
These projects help understand how user input and output work in real applications.
...
### Concepts Used
`list`, `len`, `sum`, `split`, indexing, sorting, filtering

### 🧪 Mini Projects:
- Fruit list operations
- Sum of list numbers
- Filter numbers greater than 10
- Sort names of friends
...
### Concepts Used
`def`, `return`, parameters, functions
